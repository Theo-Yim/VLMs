...
from Ovis2_5.HF_Repo.modeling_ovis2_5 import Ovis2_5
from Ovis2_5.HF_Repo.configuration_ovis2_5 import Ovis2_5_Config
...
class Ovis25Inference:
    ...
    def single_image_inference(self, 
        ...
        Args:
            ...
            max_new_tokens: Maximum new tokens to generate (default: 3072)
    ...
    def single_image_inference_streaming(self, 
                                       image_input: Union[str, Image.Image], 
                                       text_prompt: str,
                                       enable_thinking: bool = False,
                                       enable_thinking_budget: bool = False,
    ...
    def multi_image_inference(self,
                            image_paths: List[Union[str, Image.Image]],
                            text_prompt: str,
                            max_new_tokens: int = 3072,  # Fixed: was 1024
                            temperature: float = 0.1,
                            do_sample: bool = True,
                            max_pixels: int = 896*896) -> str:
        """
    ...
    def text_only_inference(self,
                          ...
                          enable_thinking: bool = False,
                          enable_thinking_budget: bool = False,
                          thinking_budget: int = 2048) -> str:  # Fixed: was 1024
        """
    ...
    def grounding_inference(self,
                          image_input: Union[str, Image.Image],
                          text_prompt: str,
                          request_type: str = "box") -> str:
        """
...
def demonstrate_parameter_validation():
    """
    Demonstrate parameter validation for thinking budget
    """
    ...
    try:
        ...
        ovis.single_image_inference(
            image_input="sample_image.jpg",
            text_prompt="Test",
            enable_thinking=True,
            enable_thinking_budget=True,
            thinking_budget=2048,
            max_new_tokens=2048  # Too small: should be > 2048 + 25 = 2073
        )
    ...
    response = ovis.single_image_inference(
        ...
        enable_thinking_budget=True,
        thinking_budget=2048,
        max_new_tokens=3072  # Valid: 3072 > 2048 + 25
    )
